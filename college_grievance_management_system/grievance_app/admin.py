...
class CustomUserAdmin(UserAdmin):
    list_display = ('username', 'email', 'first_name','last_name','enrollment_number', 'semester', 'is_student', 'is_faculty_staff', 'is_admin', 'department')
    ...
    fieldsets = (
        ...
        ('Personal Information', {
            'fields': ('email','first_name','last_name', 'enrollment_number', 'semester', 'department')
        }),
        ('Permissions', {
