# Generated by Django 5.2.4 on 2026-03-04 07:56
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='grievance_app.faculty')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='grievance_app.faculty')),
            ],
        ),
        migrations.CreateModel(
            name='CollegeAlert',
            fields=[
                ...
                ('target_faculties', models.ManyToManyField(to='grievance_app.faculty', verbose_name='Target Faculties/Departments')),
            ],
        ),
        migrations.CreateModel(
            name='Grievance',
            fields=[
                ...
                ('faculty', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='grievance_app.faculty', verbose_name='Related Faculty/Department')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grievance', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='grievance_app.grievance')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('receiver', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='received_messages', to='grievance_app.faculty')),
                ('sender', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='sent_messages', to='grievance_app.faculty')),
            ],
        ),
    ]
